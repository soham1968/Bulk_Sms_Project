...
if (mysqli_num_rows($res) > 0) {
    ...
    if (mysqli_num_rows($res0) > 0) {
        ...
        if (mysqli_num_rows($res1) > 0) {
            ...
            if ($schedule != " " && $schedule >= $curr_time) {
                // echo $schedule . " > ";
                // echo $curr_time . " ";
                ...
                `credit_used`, 
                `scheduled`, `status`)
                 VALUES      ('$username','$msg_sec','$template','$targetLanguage','$msg_id','$msg_body','$val_num','$sender_name','$service','','','$msg_credit','$schedule','success')";
                ...
                $randam4 = array(
                    'Message' => 'Rejected, Schedule is not set properly',
                    'Delivered' => 'Undelivered'
                );
                echo json_encode($randam4);
            }
        } else {
