            ...
            <div class="icon_info">
               <ul class="user_profile_dd">
                  <li>
                     ...
                     ?>
                        <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" height="35" src="uploads/profile_photos/<?php echo $reg['profile_photo'] ?>" alt="#" /><span class="name_user"> <?php echo $reg['Name']; ?></span></a>
                     <?php
                     } else {
                     ?>
