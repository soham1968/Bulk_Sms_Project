...
<nav id="sidebar">
   ...
   <div class="sidebar_blog_2">
      ...
      <ul class="list-unstyled components">
         ...
         <li><a id="price" href="price.php"><i class="fa fa-money yellow_color"></i> <span>Pricing</span></a></li>
         <li><a id="log" href="logout.php"><i class="fa fa-sign-out green_color"></i> <span>Log Out</span></a></li>
      </ul>
   </div>
</nav>