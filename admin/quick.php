                                ...
                                <div class="white_shd full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h2><i class="fa fa-envelope-o"></i> Quick Message</h2>
                                            <?php
                                            if (@$_SESSION['showAdminQuick'] == true) {
                                            ?>
                                                <div class="alert alert-success alert-dismissible">
                                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                    <strong>Success !</strong> <?php echo $_SESSION['showAdminQuick'] ?>
                                                </div>
                                            <?php
                                            }
                                            unset($_SESSION['showAdminQuick']);
                                            ?>

                                            <?php
                                            if (@$_SESSION['showAdminQuickError'] == true) {
                                            ?>
                                                <div class="alert alert-warning alert-dismissible">
                                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                    <strong>Warning !</strong> <?php echo $_SESSION['showAdminQuickError'] ?>
                                                </div>
                                            <?php
                                            }
                                            unset($_SESSION['showAdminQuickError']);
                                            ?>
                                        </div>
                                    </div>
                                    <div class="padding_infor_info padding-bottom_3">
                                        <form method="post" id="formID" action="submit.php">
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Mobile Numbers</label>
                                                <textarea class="form-control" id="phoneNumbers" rows="3" name="phoneNumbers"></textarea>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="message" value="hi" name="message" required rows="5"></textarea>
                                            </div>
                                            ...
                                            <div class="row  align-items-center">
                                                <div class="col-md-5 input-group ">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="file" accept=".xls,.xlsx,.csv" id="file">
                                                        <label class="custom-file-label" for="file">Choose file</label>
                                                    </div>
                                                    <!-- <small>Please check your </small> -->
                                                </div>
                                                <div class="col-md-3 form-group p-0 pl-2 m-0">
                                                ...
                                                <div class="col-md-4 form-group p-0 m-0">
                                                    <input id="dd" type="datetime-local" name="schedule" class="form-control" style="width:10rem; display:none;">
                                                </div>
                                            </div>
                                            <div class="form-group padding-bottom_3">
                                                <input type="text" id="no_of_msg" style="display: none;" name="no_of_msg">
                                                <small>Please make sure that your phone numbers are in the <strong>first
                                                        column</strong></small>
                                            </div>
                                            <!-- <button type="submit" class="btn text-white">Send</button> -->
                                            <input type="submit" name="submit_quick" value="submit" style="background-color:#ff5722; padding:7px 15px 7px 15px;" class="btn text-white">
                                        </form>
