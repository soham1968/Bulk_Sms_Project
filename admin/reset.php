                        ...
                        <form action="forget_link.php" method="post">
                            <fieldset>
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" minlength="8" maxlength="15" name="password" placeholder="Password">
                                </div>
                                <div class="field">
                                ...
                                <div class="field">
                                    <a style="margin-left:2rem;" id="code" class="disabled" href="forget_link.php?resend_code=<?php echo $_SESSION['for_email'] ?>" id="anchor">Resend Verificartion Code</a>
                                </div>
