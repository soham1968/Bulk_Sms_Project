                                 ...
                                 <div class="white_shd full margin_bottom_30">
                                    ...
                                    <div class="padding_infor_info">
                                       ...
                                       if (mysqli_num_rows($lessonQw) > 0) {
                                          ...
                                          $api = $a['api'];
                                       ?>
                                          <p>http://localhost/bulk/admin/api_quick.php?username=<?php echo $username ?>&api=<?php echo $api ?>&sender_name=XXXXXX&service=XXXXXX&template=XXXXX&msg_body=XXXXXX&num=XXXXXXX&input_language=XX&target_language=XX
                                          </p>
                                       <?php
                                       } else {
                                       ?>
                                          <p>http://localhost/bulk/admin/api_quick.php?username=<?php echo $username ?>&api=XXXXXX&sender_name=XXXXXX&service=XXXXXX&template=XXXXX&msg_body=XXXXXX&num=XXXXXXX&input_language=XX&target_language=XX</p>
                                       <?php
                                       }
                                       ?>
                                 ...
                                 <div class="white_shd full margin_bottom_30">
                                    ...
                                    <div class="padding_infor_info">
                                       ...
                                       if (mysqli_num_rows($lessonQw) > 0) {
                                          ...
                                          $api = $a['api'];
                                       ?>
                                          <p>http://localhost/bulk/admin/api_schedule.php?username=<?php echo $username ?>&api=<?php echo $api ?>&sender_name=XXXXXX&service=XXXXXX&schedule=YYYY-DD-MM_HH:MM:SS&template=XXXXX&msg_body=XXXXXX&num=XXXXXXX&input_language=XX&target_language=XX
                                          </p>
                                       <?php
                                       } else {
                                       ?>
                                          <p>http://localhost/bulk/admin/api_schedule.php?username=<?php echo $username ?>&api=XXXXXX&sender_name=XXXXXX&service=XXXXXX&schedule=YYYY-DD-MM_HH:MM:SS&template=XXXXX&msg_body=XXXXXX&num=XXXXXXX&input_language=XX&target_language=XX</p>
                                       <?php
                                       }
                                       ?>
                                    </div>
                                 ...
                                 <div class="white_shd full margin_bottom_30">
                                    ...
                                    <div class="padding_infor_info">
                                       ...
                                       if (mysqli_num_rows($lessonQw) > 0) {
                                          ...
                                          $api = $a['api'];
                                       ?>
                                          <p>http://localhost/bulk/admin/api_group.php?username=<?php echo $username ?>&api=<?php echo $api ?>&sender_name=XXXXXX&service=XXXXXX&group_name=XXXXX&template=XXXXX&msg_body=XXXXXX&input_language=XX&target_language=XX
                                          </p>
                                       <?php
                                       } else {
                                       ?>
                                          <p>http://localhost/bulk/admin/api_group.php?username=<?php echo $username ?>&api=XXXXXX&sender_name=XXXXXX&service=XXXXXX&group_name=XXXXX&template=XXXXX&msg_body=XXXXXX&input_language=XX&target_language=XX</p>
                                       <?php
                                       }
                                       ?>
                                    </div>
                                 ...
                                 <div class="white_shd full margin_bottom_30">
                                    ...
                                    <div class="padding_infor_info">
                                       ...
                                       if (mysqli_num_rows($lessonQw) > 0) {
                                          ...
                                          $api = $a['api'];
                                       ?>
                                          <p>http://localhost/bulk/admin/api_balance.php?username=<?php echo $username ?>&api=<?php echo $api ?>
                                          </p>
                                       <?php
                                       } else {
                                       ?>
                                          <p>http://localhost/bulk/admin/api_balance.php?username=<?php echo $username ?>&api=XXXXXX
                                          <?php
                                       }
                                          ?>
                                    </div>
                                 ...
                                 <div class="white_shd full margin_bottom_30">
                                    ...
                                    <div class="padding_infor_info">
                                       ...
                                       if (mysqli_num_rows($lessonQw) > 0) {
                                          ...
                                          $api = $a['api'];
                                       ?>
                                          <p>http://localhost/bulk/admin/api_delivery.php?username=<?php echo $username ?>&api=<?php echo $api ?>&msg_id=XXXXX
                                          </p>
                                       <?php
                                       } else {
                                       ?>
                                          <p>http://localhost/bulk/admin/api_delivery.php?username=<?php echo $username ?>&api=XXXXXX&msg_id=XXXXX
                                          <?php
                                       }
                                          ?>
                                    </div>
